    ...
    <div class="content">
        <div class="form-container">
            ...
            if(isset($_GET['id']))
            {
                ...
                $query = "SELECT * FROM unisson WHERE id='$user_id' ";
                    ...
                    <form action="../action.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="update_category" id="update_category" required>
                                ...
                                <option value="unisson" selected>Unisson</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Edit Audio" name="update_unisson">
                        </div>
                ...
                {
                    echo "<h4>No Unisson Audio Found</h4>";
                }
            }
            ?>
        </div>
