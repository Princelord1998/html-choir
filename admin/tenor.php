...
<div class="document">
    ...
    <div class="sidebar">
        <ul>
            ...
            <li><a href="tenor.php" style="background-color: red">Tenor</a></li>
        </ul>
    </div>
    <div class="content">
        <h1>Chant Tenor</h1>
        <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <audio controls style="height: 25px">
                                <source src="../tenor_audio/<?= $user['title']; ?>" type="audio/mp3">
                                Your browser does not support the audio element.
                            </audio>
                            <a href="tenor_edit.php?id=<?= $user['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                            <form id="delete_tenor" action="../action.php" method="POST" class="d-inline">
                                <button onclick="return confirm('Are you sure you wanna delete audio?')" style="width: 60px" type="submit" name="delete_tenor" value="<?=$user['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                            </form>
                        </td>
                    </tr>
                    <?php
            ...
            {
                echo "<h5> No Tenor Audio Found </h5>";
            }
            ?>
