...
<div class="document">
    ...
    <div class="content">
        ...
        <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <audio controls style="height: 25px">
                                <source src="../bass_audio/<?= $user['title']; ?>" type="audio/mp3">
                                Your browser does not support the audio element.
                            </audio>
                            <a href="bass_edit.php?id=<?= $user['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                            <form action="../action.php" method="POST" class="d-inline">
                                <button onclick="window.confirm('Are you sure you wanna delete audio?')" style="width: 60px" type="submit" name="delete_bass" value="<?=$user['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                            </form>
                        </td>
                    </tr>
                    <?php
            ...
            {
                echo "<h5> No Bass Audio Found </h5>";
            }
            ?>
