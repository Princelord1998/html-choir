...
<div class="document">
    ...
    <div class="sidebar">
        <ul>
            ...
            <li><a href="alto.php" style="background-color: red">Alto</a></li>
    ...
    <div class="content">
        ...
        <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <audio controls style="height: 25px">
                                <source src="../alto_audio/<?= $user['title']; ?>" type="audio/mp3">
                                Your browser does not support the audio element.
                            </audio>
                            <a href="alto_edit.php?id=<?= $user['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                            <form action="../action.php" method="POST" class="d-inline">
                                <button onclick="window.confirm('Are you sure you wanna delete audio?')" style="width: 60px" type="submit" name="delete_alto" value="<?=$user['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                            </form>
                        </td>
                    </tr>
                    <?php
            ...
            {
                echo "<h5> No Alto Audio Found </h5>";
            }
            ?>
