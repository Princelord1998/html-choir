    ...
    <div class="content">
        <div class="form-container">
            ...
            if(isset($_GET['id']))
            {
                ...
                $query = "SELECT * FROM soprano WHERE id='$user_id' ";
                    ...
                    <form action="../action.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="update_category" id="update_category" required>
                                ...
                                <option value="soprano" selected>Soprano</option>
                        ...
                        <div class="form-group">
                            <input type="submit" value="Edit Audio" name="update_soprano">
                        </div>
                ...
                {
                    echo "<h4>No Soprano Audio Found</h4>";
                }
            }
            ?>
        </div>
